...
return [
    ...
    | las de tamaño. Puedes ajustar cada mensaje aquí (RNF-11).
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Traducen el nombre técnico del campo a un nombre legible para el usuario
    | (p. ej. "correo electrónico" en vez de "email") en los mensajes de error.
    |
    */
